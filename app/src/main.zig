...
const virtual_mouse_core = @import("virtual_mouse/core.zig");
const virtual_mouse_objects = @import("virtual_mouse/objects.zig");
...
comptime {
    ...
    _ = route_table;
    _ = native_input;
    _ = virtual_mouse_core;
    _ = virtual_mouse_objects;
}
