...
export interface InputSnapshot {
  readonly id: number;
  readonly mouse: { readonly point: { readonly x: number; readonly y: number }; readonly buttons: number; readonly known: boolean };
  readonly keyboard: { readonly keys: readonly number[]; readonly known: boolean };
...
export type VirtualInputResult = { readonly completedActions: number; readonly input: InputSnapshot | null; readonly calibration?: { readonly updated: boolean } | null };
