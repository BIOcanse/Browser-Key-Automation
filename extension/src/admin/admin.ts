...
let publicTrialKeyActive = false;
...
function renderKey(record: PublicKeyRecord): void {
  ...
  if (record.keyId === PUBLIC_TRIAL_KEY_ID) {
    const trialLabel = document.createElement("span");
    trialLabel.className = "badge badge-legacy";
    trialLabel.textContent = t("trialKeyTitle");
    nameCell.append(trialLabel);
  }
...
function renderRows(): void {
  requiredElement<HTMLElement>("[data-trial-key-warning]").hidden = !publicTrialKeyActive;
